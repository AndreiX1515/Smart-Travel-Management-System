                      ...
                      foreach ($guestData['files'][$fileType] as $file)  // ✅ Now correctly accessing both
                      {
                        ...
                        echo "<div >
                                ...
                                <a class='btn btn-info my-1 btn-sm' 
                                  href='../Agent Section/functions/view-file.php?file=" . urlencode($filePath) . "' target='_blank'>View File
                                </a> 

                                <a class='btn btn-success btn-sm' 
                                  href='../Agent Section/functions/download.php?file=" . urlencode($filePath) . "' target='_blank'>Download File
                                </a>

        ...
        <div class="content">
            ...
            <div class="custom-tabs">
              <ul class="tab-nav" id="pills-tab" role="tablist">
                ...
                <li class="tab-item" role="presentation">
                  <button class="tab-button" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Completed</button>
                </li>
                <li class="tab-item" role="presentation">

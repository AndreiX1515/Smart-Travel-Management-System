<div class="table-container">
  <table id="product-table-pending" class="product-table">
    <thead>
      <tr>
...
<script>
  ...
  {
    const tablePending = $('#product-table-pending').DataTable(
    {
    ...
    {
      const info = tablePending.page.info();
    ...
    {
      tablePending.page('previous').draw('page');
      updatePagination();
    });

    $('#nextPage').on('click', function() 
    {
      tablePending.page('next').draw('page');
      updatePagination();
    });
    ...
    $('#status').on('change', function () 
    {
        ...
        tablePending.column(8).search(selectedStatus || '').draw();
    });
    ...
    $('#packages').on('change', function () 
    {
      ...
      tablePending.column(3).search(selectedPackage || '').draw();
    });
    ...
    $('#BookingStartDate').on('change', function () 
    {
      ...
      tablePending.column(4).search(selectedBookingDate || '').draw();  // Column 4 (index starts at 0)
    });
    ...
    $('#FlightStartDate').on('change', function () 
    {
      ...
      tablePending.column(5).search(selectedFlightDate || '').draw();  // Column 5 (index starts at 0)
    });
    ...
    $("#FlightStartDate").datepicker(
    {
      ...
      onSelect: function(dateText) 
      {
        ...
        tablePending.column(5).search(flightStartDate || '').draw();  // Column 5 (index starts at 0)
      }
    });
    ...
    $("#BookingStartDate").datepicker(
    {
      ...
      onSelect: function(dateText) 
      {
        ...
        console.log("FlightStartDate Selected Date (onSelect): " + dateText);
        tablePending.column(4).search(bookingStartDate || '').draw();  // Column 5 (index starts at 0)
      }
    });
    ...
    $("#BookingStartDate").on("input", function () 
    {
      ...
      // Update the tablePending  column search
      tablePending.column(5).search(bookingStartDate || '').draw(); // Column 5 (index starts at 0)

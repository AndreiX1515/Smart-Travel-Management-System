            ...
            <div class="date-range-wrapper flightbooking-wrapper">
              <div class="date-range-inputs-wrapper">
                <div class="input-with-icon">
                  <input type="text" class="datepicker" id="FlightStartDate" placeholder="Payment Date" readonly>
            ...
            <tbody>
              <?php
                if ($agentRole != 'Head Agent') {
                  $sql1 = "SELECT b.transactNo, f.flightDepartureDate, p.paymentId, p.amount, p.filePath, p.paymentDate, p.paymentStatus, f.flightDepartureDate,
                            p.paymentRemarks
                          FROM `booking` b

    ...
    <div class="main-container">
      <div class="content-header">
        <div class="back-button-wrapper">
          ...
          <button type="button" class="back-button-link" id="backWarning">
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-body text-center">
              <p>Your transaction will remain pending and won't be finalized without payment. If unpaid, it will be discarded after 3 days.</p>
            </div>

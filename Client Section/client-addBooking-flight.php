        ...
        <div class="booking-wrapper">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <input type="hidden" id="agentCode" name="agentCode" value="<?php echo $_SESSION['clientCode']; ?>"
              ...
              <input type="hidden" name="agentId" id="agentId" value="<?php echo $_SESSION['clientId']; ?>"

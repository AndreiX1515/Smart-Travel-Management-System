...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 06, 2024 at 10:27 AM
...
CREATE TABLE `payment` (
  ...
  `paymentStatus` enum('Pending','Confirmed','Cancelled') DEFAULT NULL,
...
INSERT INTO `payment` (`paymentId`, `transactNo`, `accountId`, `paymentTitle`, `paymentType`, `amount`, `proof`, `paymentDate`, `paymentStatus`, `details`) VALUES
(1, 'A002-000045', 2, 'Package Payment', 'Downpayment', 1000.00, 0x2e2e2f2e2e2f75706c6f6164732f413030322d3030303034352d31312d30362d323032345f31302d30372e706e67, '2024-11-06 17:07:28', 'Pending', NULL);
...
INSERT INTO `request` (`requestId`, `transactNo`, `accountId`, `concern`, `details`, `requestCost`, `requestDate`, `requestStatus`) VALUES
(1, 'A002-000045', 2, 'Additional Baggage', '20 kg one way for 2', NULL, '2024-11-06 16:18:54', 'Pending'),
(2, 'A002-000045', 2, 'Additional Headcount', '2', NULL, '2024-11-06 16:19:27', 'Pending');

...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 21, 2025 at 08:35 AM
...
(1, 'A001', 'BU2', 1, 2, 'Veronica', 'Hantazo', '', '+63', '9957563947', 'Retailer', 'Head Agent', 0, 10),
(2, 'A002', 'BU7', 2, 7, 'Amie', 'Demapindan', '', '+63', '9177149418', 'Retailer', 'Head Agent', 0, 10),
(3, 'A003', 'BU5', 3, 5, 'Julyanna', 'Francia', '', '+63', '9778127977', 'Wholeseller', 'Head Agent', 10, 10),
(4, 'A004', 'BU6', 4, 6, 'Jonna', 'Test', '', '+63', '99999999999', 'Wholeseller', 'Head Agent', 10, 10),
(5, 'A005', 'BU4', 5, 4, 'Winie', 'Hantazo', '', '+63', '9999999999', 'Retailer', 'Head Agent', 0, 10),
(6, 'A006', 'BU1', 28, 1, 'Juan', 'Cruz', 'Andres', '+63', '999999999', 'Retailer', 'Head Agent', 0, 10),
(7, 'A007', 'BU3', 29, 3, 'Maria', 'Santos', 'Beatriz', '+63', '999999999', 'Retailer', 'Head Agent', 0, 10);
...
INSERT INTO `client` (`id`, `clientId`, `clientCode`, `accountId`, `branchId`, `fName`, `lName`, `mName`, `countryCode`, `contactNo`, `clientType`, `clientRole`, `seats`) VALUES
(1, 'C001', 'BU2', 6, 2, 'Juan', 'Dela Cruz', '', '+63', '9999999999', 'Retailer', 'Sub Agent', 10),
(2, 'C002', 'BU4', 7, 4, 'George', 'Anton', NULL, '+63', '9999999999', 'Retailer', 'Sub Agent', 10);
...
(3, 'BU2-000033', 6, 2, 10, NULL, NULL, NULL, 1, '', 1100.00, '2025-02-21 14:29:49', 'Submitted', NULL),
(4, 'BU2-000033', 6, 1, 8, NULL, NULL, NULL, 2, '', 640.00, '2025-02-21 14:29:57', 'Submitted', NULL);
...
('bndrto4m83ah7o37qirv5ljme7', 1, '2025-02-21 08:16:14', '2025-02-21 08:16:14', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/133.0.0.0 Safari/537.36'),
('ene55eo8a3do4di9l1ta4f8qid', 13, '2025-02-21 07:49:49', '2025-02-21 07:49:49', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/133.0.0.0 Safari/537.36');
...
--
ALTER TABLE `auditbooking`
  MODIFY `auditId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;

--
-- AUTO_INCREMENT for table `auditpayment`
--
ALTER TABLE `auditpayment`
  MODIFY `auditId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;

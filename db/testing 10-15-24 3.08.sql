...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 15, 2024 at 09:08 AM
...
(39, 2, 'TRANS-0000039', 1, 0, 0, 1, 36888.00, '2024-10-15 11:50:47', 0.00, 'Pending'),
...
INSERT INTO `inquiry` (`inquiryId`, `transactNo`, `agentId`, `concern`, `details`) VALUES
(1, 'TRANS-0000033', 1, 'Additional Baggage', 'testing');
...
('r78m74tnfrpgc49ekrl4ghohp9', 2, '2024-10-15 14:45:02', '2024-10-15 15:08:16', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36');
...
--
ALTER TABLE `guest`
  MODIFY `guestId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;

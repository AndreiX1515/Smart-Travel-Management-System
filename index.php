...
<body>
    ...
    <header class="header d-flex justify-content-between align-items-center">
      ...
      <div class="dropdown">
          <a href="#" class="nav-link dropdown-toggle" id="hotelDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
              Hotel
          </a>
    ...
    <!-- <div class="dropdown">
        <a href="#" class="nav-link dropdown-toggle" id="othersDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            Others
        </a>
        <ul class="dropdown-menu" aria-labelledby="othersDropdown">
            <li><a class="dropdown-subitem" href="#">Visa Requirements</a></li>
        </ul>
    </div> -->

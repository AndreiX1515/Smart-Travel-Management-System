    ...
    <li class="nav-item dropdown">
        ...
        <div class="collapse" id="manageBookingMenu">
           <ul class="nav flex-column ms-3">
               <li class="nav-item">
                   <a class="nav-link page-button" href="../SuperAdmin/admin-manageEmployee.php" data-page-name="Manage Employee">
                        Employee
                    </a>
               </li>
               <li class="nav-item">
                    <a class="nav-link page-button" href="../SuperAdmin/admin-manageAgent.php" data-page-name="Manage Agent">
                        Agent
                    </a>
               </li>
               <li class="nav-item">
                    <a class="nav-link page-button" href="../SuperAdmin/admin-manageFlight.php" data-page-name="Manage Flight">
                        Flight
                    </a>
               </li>
           </ul>

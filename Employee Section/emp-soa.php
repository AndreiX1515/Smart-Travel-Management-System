...
<body>
  ...
  <div class="main-container">
    ...
    <div class="main-content">
      ...
      <!-- Radio Buttons: Filter Mode -->
      <div class="mb-3">
        <label>Filter by:</label><br />
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="filterMode" id="filterByFlight" value="flight" checked>
      ...
      <div class="row">
        ...
        <div class="col-md-6 mb-3">
          <label for="company-filter">Select Branch:</label>
        ...
        <!-- Flight Date Select -->
        <div class="col-md-6 mb-3 filter-flight" id="flight-container">
        ...
        <!-- Month Select -->
        <div class="col-md-3 mb-3 filter-month" id="month-container" style="display:none;">
        ...
        <!-- Year Select -->
        <div class="col-md-3 mb-3 filter-month" id="year-container" style="display:none;">

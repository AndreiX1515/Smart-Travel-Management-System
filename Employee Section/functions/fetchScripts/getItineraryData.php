...
$sqlDays = "
  ...
  LEFT JOIN (
    SELECT imp.dayId, GROUP_CONCAT(DISTINCT md.mealName ORDER BY md.mealId ASC SEPARATOR ',') AS meals
...
// Output final result
echo json_encode($itinerary, JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT);
?>

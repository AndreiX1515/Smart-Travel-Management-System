      ...
      <div class="page-header-wrapper">
        ...
        <div class="page-header-content">
          <div class="page-header-text">
            <h5 class="header-title">Manage Flights</h5>
          </div>
        </div>
      ...
      <div class="table-container">
        ...
        <ul class="nav nav-pills mb-3" id="flightTab" role="tablist">
          <li class="nav-item" role="presentation">
            <button class="nav-link active" id="list-tab" data-bs-toggle="pill" data-bs-target="#list" type="button"
              role="tab">Flight List</button>
          </li>
          <li class="nav-item" role="presentation">
            <button class="nav-link" id="entry-tab" data-bs-toggle="pill" data-bs-target="#entry" type="button"
              role="tab">Add Flight Date</button>
          </li>
        </ul>

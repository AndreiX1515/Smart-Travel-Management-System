...
$(document).ready(function() {
    $('#logoutButton').click(function() {
        $.ajax({
            url: '../Employee Section/functions/emp-logout.php', // Employee-specific logout
            type: 'GET',
            dataType: 'json',
            success: function(response) {
                if (response.success) {
                    window.location.href = '../Agent Section/agentLogin.php'; // Redirect to employee login
                } else {
            ...
            error: function(jqXHR, textStatus, errorThrown) {
                ...
                window.location.href = '../Agent Section/agentLogin.php'; // Ensure redirection
            }
        });
    });
});

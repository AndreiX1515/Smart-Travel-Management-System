                        ...
                        <div class="row mb-2">
                            ...
                            <div class="columns col-md-4">
                                <div class="column-header">
                                    <label for="flightDate">Voucher Name:
                                        <span class="text-danger"> *</span>
                                    </label>
                                </div>

                                <div class="form-group">
                                    <input type="text" class="form-control disabled" id="itineraryName" name="itineraryName"
                            ...
                            <div class="columns col-md-4">
                                <div class="column-header">
                                    <label for="flightDate">Voucher Code
                                    </label>
                                </div>
                                        ...
                                        <div class="date-range-inputs-wrapper">
                                            <div class="input-with-icon">
                                                <input type="text" class="datepicker" id="PeriodStartDate"
                                                    placeholder="Start" value="<?= $voucher['details']['tourPeriodStart']; ?>"
                                                    readonly>
                                        ...
                                        <div class="date-range-inputs-wrapper">
                                            <div class="input-with-icon">
                                                <input type="text" class="datepicker" id="PeriodEndDate"
                                                    placeholder="End" value="<?= $voucher['details']['tourPeriodEnd']; ?>">
                                                <i class="fas fa-calendar-alt calendar-icon"></i>
                                            </div>
                                        </div>
                                    </div>

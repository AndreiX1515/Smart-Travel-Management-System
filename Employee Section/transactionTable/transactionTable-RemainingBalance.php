<div class="table-container">
    ...
    <div class="navpills-container">
        <div class="filter-tabs" id="booking-filter-tabs">
            ...
            <!-- All Button -->
            <button class="filter-btn active" data-filter="">5 Days
            ...
            <!-- Pending Button -->
            <button class="filter-btn" data-filter="Pending">10 Days
                <span class="badge-status-tab">
                    <h6>
                        <?php
                        $sql = "SELECT COUNT(*) AS totalBookings FROM booking 
            ...
            <!-- Reserved Button -->
            <button class="filter-btn" data-filter="Reserved">15 Days
                <span class="badge-status-tab">
                    <h6>
                        <?php
                        $sql = "SELECT COUNT(*) AS totalBookings FROM booking 
            ...
            <!-- Confirmed Button -->
            <button class="filter-btn" data-filter="Confirmed">30 Days
                <span class="badge-status-tab">
                    <h6>
                        <?php
                        $sql = "SELECT COUNT(*) AS totalBookings FROM booking 
    ...
    <div class="body-content-wrapper">
        <div class="table-wrapper">
            <table class="remaining-table" id="remaining-table">
                <thead>
                    <tr>
                        <th>TRANSACT NO</th>
                        <th>BRANCH</th>

        ...
        <div class="card">
          ...
          <div class="card-content card-content-body">
            ...
            <div class="row">
              ...
              <div class="col-md-5 clickable-card"
                onclick="window.location.href='../Employee Section/emp-transaction.php'">
              ...
              <div class="col-md-5 clickable-card" onclick="redirectToAgentTransaction('Confirmed')">
            ...
            <div class="row">
              ...
              <div class="col-md-4 clickable-card" onclick="redirectToAgentTransaction('Pending')">
              ...
              <div class="col-md-4 clickable-card" onclick="redirectToAgentTransaction('Reserved')">
              ...
              <div class="col-md-4 clickable-card card-cancelled" onclick="redirectToAgentTransaction('Cancelled')">
            ...
            <div class="row">
              <div class="col-md-5 d-flex flex-row total-sales">
                ...
                <div class="side-content d-flex flex-column">
                  <?php
                  $currentMonthQuery = "
                  SELECT SUM(b.totalPrice + IFNULL(r.requestCost, 0)) AS totalSales
                  FROM booking b
                  LEFT JOIN request r 
              ...
              ";
                  ...
                  $currentMonthTotal = isset($currentMonthRow['totalSales']) && $currentMonthRow['totalSales'] !== null
                    ? sprintf('%.2f', (float) $currentMonthRow['totalSales'])
                    : '0.00';
              ...
              <div class="col-md-5 d-flex flex-row total-sales">
                ...
                <div class="side-content d-flex flex-column">
                  ...
                  if ($pastMonthResult && $pastMonthResult->num_rows > 0) {
                    $row = $pastMonthResult->fetch_assoc();
                    $pastMonthTotal = sprintf('%.2f', (float) ($row['totalSales'] ?? 0));
                  } else {
                    $pastMonthTotal = '0.00';
                  }
                  ?>
        ...
        <div class="card card-4">
          <div class="header">
            ...
            <div class="button-wrapper">
              <button class="btn btn-primary view-currency-btn" id="addCurrencyBtn" onclick="window.location.href='../Employee Section/emp-currencyHistory.php';">
